...
- PASS Serverless code analysis: 5 Lambda functions available for authenticated code vulnerability scanning
- PASS Active Lambda scanning: 5 functions actively scanned by Inspector
